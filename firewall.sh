...
# Author: Nicolargo
#
# Modification to allow OpenVPN nomade client - ixalle
#
# chkconfig: 2345 9 91
...
#VPN
/sbin/iptables -A INPUT -i as0t0 -j ACCEPT
/sbin/iptables -A INPUT -i as0t1 -j ACCEPT
/sbin/iptables -A FORWARD -i as0t0 -j ACCEPT
/sbin/iptables -A FORWARD -i as0t1 -j ACCEPT
/sbin/iptables -A FORWARD -i as0t0 -o eth0 -m state --state RELATED,ESTABLISHED -j ACCEPT
/sbin/iptables -A FORWARD -i as0t1 -o eth0 -m state --state RELATED,ESTABLISHED -j ACCEPT
/sbin/iptables -A FORWARD -i eth0 -o as0t0 -m state --state RELATED,ESTABLISHED -j ACCEPT
/sbin/iptables -A FORWARD -i eth0 -o as0t1 -m state --state RELATED,ESTABLISHED -j ACCEPT
/sbin/iptables -t nat -A POSTROUTING -s 172.27.224.0/20 -o eth0 -j MASQUERADE
/sbin/iptables -A OUTPUT -o as0t0 -j ACCEPT
/sbin/iptables -A OUTPUT -o as0t1 -j ACCEPT
# Remote testing
